...
def save_data():
    with open(DATA_FILE, "w", encoding="utf-8") as f:
        json.dump(numbers_db, f, ensure_ascii=False, indent=2)
    with open(USED_FILE, "w", encoding="utf-8") as f:
        json.dump(used_stats, f, ensure_ascii=False, indent=2)
    with open(USERS_FILE, "w", encoding="utf-8") as f:
        json.dump({"users": users_data, "active_numbers": active_numbers}, f, ensure_ascii=False, indent=2)
...
def load_data():
    ...
    if os.path.exists(USERS_FILE):
        with open(USERS_FILE, "r", encoding="utf-8") as f:
            ...
            active_numbers = data.get("active_numbers", {})
    else:
        users_data = {}
        active_numbers = {}
